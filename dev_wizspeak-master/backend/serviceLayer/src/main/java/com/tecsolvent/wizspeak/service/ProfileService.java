...
public class ProfileService {
	...
	public ArrayList<Post> getProfilePosts(String userIdStr,String visitorIdStr, int page,long lastId)throws Exception{
		...
		guavaAndCouchbaseCache.putObjectAsByteInCache("profilePostd"+userId+"p"+page+"last"+lastId, newPostArray);
	...
	public boolean addUserProfilePic(String link,String userStr) throws Exception{
		...
		try{
			...
			int wall_type = 1;
			groupService.profilePic(link,userStr,wall_type);
