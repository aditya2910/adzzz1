...
$client_id = '529155930764-52pd8rqp23f12b5p4pdiu2r7j9ch3p14.apps.googleusercontent.com'; // Enter your Client ID here
$client_secret= 'apZUAuJ15Vh2kOWWBlx8pIEG'; // Enter your Client Secret here
$APPNAME = "wizspeakyoutube";

$path=  $_SERVER['DOCUMENT_ROOT'].'/wizspeaks/app/webroot/upload/creativity/video/process/11463829840.mp4';
$videoPath = $path;
$videoTitle = "Just an Example Titleddddddddddddddddddd";
...
try{
    ...
    if ($client->getAccessToken()) {
        ...
        if ($status->status['uploadStatus'] == 'uploaded') {
			$code= '529155930764-52pd8rqp23f12b5p4pdiu2r7j9ch3p14.apps.googleusercontent.com';
