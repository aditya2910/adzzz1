...
class AuthTest extends BaseTest
{
  ...
  public function setUp()
  {
    $this->signer = new Google_Signer_P12(
        file_get_contents(__DIR__ . 'AuthTest.php/' .self::PRIVATE_KEY_FILE, true),
        "notasecret"
    );
    $this->pem = file_get_contents(__DIR__ . 'AuthTest.php/' .self::PUBLIC_KEY_FILE, true);
...
PK;
  ...
  public function testCantOpenP12()
  {
    ...
    try {
      new Google_Signer_P12(
          file_get_contents(__DIR__ . 'AuthTest.php/' .self::PRIVATE_KEY_FILE, true) . "foo",
          "badpassword"
      );
      $this->fail("Should have thrown");
    } catch (Exception $e) {
