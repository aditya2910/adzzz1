...
App::uses('Component', 'Controller');
 ...
 //App::import('Vendor', 'autoload.php');
 set_include_path('/var/www/html/wizspeak/app/Vendor/vendor/google/apiclient/src/');
 // require_once '/var/www/html/wizspeak/app/Vendor/autoload.php';

    require_once '/var/www/html/wizspeak/app/Vendor/vendor/autoload.php';


require_once '/var/www/html/wizspeak/app/Vendor/vendor/google/apiclient/src/Google/Client.php';
			...
			if ($client->getAccessToken()) {
				...
				if ($status->status['uploadStatus'] == 'uploaded') {
					...
					foreach($posts as $l_post){
						...
						$url = "http://localhost:8080/backend/updateCreVideo";
						$ch = curl_init();
