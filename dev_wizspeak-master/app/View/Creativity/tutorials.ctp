				...
				<div class="filter-box">
					<a href="<?php echo APPURL.'creativity/player/'.$vid->id ?>">
						...
						<div class="filter-box-details">
							<h3><?php echo $vid->title;?></h3></a>
					<div class="details-thumb">Uploaded by <b><?php echo $vid->postby_name; ?></b>
					</div>
				</div>
			</div>
			<?php                }  ?>
				...
				<div class="filter-box">
					<div class="filter-box-thumb">
						...
						<a title="<?php echo $image->title; ?>"
						   ...
						   href="<?php echo  IMAGE_CRE_POPUP . $image->link; ?>"
						   rel="lightbox">

							<?php echo $this->Html->image(IMAGE_CRE_THUMB.$image->link);?>
			...
			<?php foreach ($Creativity_md as $key => $doc)  {
				...
				<div class="filter-box">
					...
					<div class="filter-box-details">
						...
						<div class="details-thumb">Uploaded By <b><?php echo $doc->postby_name ?></b>
						</div>
					</div>
				</div>
			<?php                }  ?>
			...
			<?php foreach ($Creativity_ma as $key => $aud) {
				...
				<div class="filter-box">
					...
					<div class="filter-box-details">
						...
						<div class="details-thumb">Uploaded by <b><?php echo $aud->postby_name ?></b>
						</div>
					</div>
				</div>
