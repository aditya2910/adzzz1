                ...
                <div class="fixed-container">
                    <div class="secodnav-left">
                        ...
                        <div class="ambition-main mobile-view">
                            <div class="ambition">Creativity</div>
                        </div>
                    ...
                    <div class="secodnav-right">
                        <ul class="ulist-secondaynav-right" >
                            <li>
								<a href="/wizspeak/creativity" style="color:#000;">Creativity</a>
							</li>
                    ...
                    <div class="content-left">
                        ...
                        <ul class="available-menu">
                            <li>
									...
									<a href= "<?php echo APPURL.'creativity/mostviewed' ?>">
                                    <span class="left-icon icon-star"></span>
                                    <span>Most Viewed</span>
                                </a>
                            </li>
							<a href= "<?php echo APPURL.'creativity/music' ?>">

                            <li>	<a href= "<?php echo APPURL.'creativity/music' ?>">
                            ...
                            <li>
									...
									<a href= "<?php echo APPURL.'creativity/movies' ?>">
                                    <span class="left-icon  icon-movies"></span>
                                    <span>Movies</span>
                                </a>
                            </li>
                            <li>
								<a href= "<?php echo APPURL.'creativity/sports' ?>">
                            ...
                            <li>
								...
								<a href= "<?php echo APPURL.'creativity/nature' ?>">
                                    <span class="left-icon  icon-nature"></span>
                                    <span>Nature</span>
                                </a>
                            </li>
                            <li>
								<a href= "<?php echo APPURL.'creativity/science'?>">
                            ...
                            <li>
								<a href= "<?php echo APPURL.'creativity/comedy'?>">
                            ...
                            <li>
									...
									<a href= "<?php echo APPURL.'creativity/tutorials'?>">
                            ...
                            <li>
									...
									<a href= "<?php echo APPURL.'creativity/animation'?>">
