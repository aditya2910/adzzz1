<div class="full-container main-content">
	<div class="fixed-container">
		<div class="left-container-profile">
						...
						<div class="cover-inner-left">
							...
							<div class="cover-pic-Disc">
								<div class="cover-pic-disc-name">
									...
									<h5 title="<?php echo $groupDetail->description; ?>" ><?php echo substr($groupDetail->description,0,20); ?></h5>
							...
							<div class="cover-pic-Disc-right">
								<div class="share">
									...
									<input type="button" id="group-user-status" value="<?php echo $Gbutton; ?>" />
									<?php
									if($userGroupRole==1){
									?>
			...
			<div class="profile-main-section group-post">
