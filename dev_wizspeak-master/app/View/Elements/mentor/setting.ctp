...
<div class="profile-row-mids">
	...
	<div class="education-desc">
		...
		<div class="edu-desc-row" id="group-title" >
			...
			<h3>name</h3>
			<h4><?php echo $userDetails->first_name.' '.$userDetails->last_name   ?></h4>
		</div>
		<div class="edu-desc-row" id="replace-group-title"   >

			<h3>name</h3>
			<textarea class="group-title" ><?php echo $userDetails->first_name.' '.$userDetails->last_name  ?></textarea>
		...
		<div id="replace-group-about" class="edu-desc-row">
			...
			<h3>status</h3>
			<textarea name="description" class="group-title" ><?php echo $userDetails->profileStatus   ?></textarea>
			<h3></h3>
...
echo $this->Form->create('User', array('type'=>'file','id'=>'uploadfile',
	'url' => array('controller' => 'mentor', 'action' => $userDetails->userId, 'setting' )));
