...
?>
                    <div class="post-users <?php echo $pvt; ?> "  id="post-user-<?php echo $post->id; ?>" >
                        <div class="post-users-head">
                            ...
                            <div class="post-user-head-details" id="postText<?php echo  $post->id; ?>">
								<h2><?php echo nl2br($post->title); ?></h2>
                                <p class="post-text"  ><?php echo nl2br($post->description); ?>
                            </div>
            ...
            <span class="volume-full">&nbsp;</span>
                ...
                <div class="post-users-video" >
                 ...
                 <?php } ?>
						...
						<?php
						if(sizeof($post->comments) > 3){

							?>
						<div class="post-users-comments" data-id="<?php echo $post->comments[0]->id; ?>" >
							<span class="more_cmt" >View previous comments</span>
						</div>
						<?php }
                        ...
                        <div class="post-users-comments comments" data-id="<?php echo $comment->id; ?>" id="post-users-comment-<?php echo $comment->id; ?>" >
							...
							<div class="postedby-image">
								<?php
								$pic = '/img/userReg.jpg';
								if(@getimagesize(IMAGE_PROFILE_WALL_COMMENT.$comment->cUserPic)){
									$pic = IMAGE_PROFILE_WALL_COMMENT.$comment->cUserPic;
								}
								 echo $this->Html->image($pic);
								?>
							</div>
