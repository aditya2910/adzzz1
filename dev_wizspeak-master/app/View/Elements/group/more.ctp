                            ...
                            <div class="upload-profilePic">
								...
								<?php
								$img = '/img/noUPic.png';
								if(@getimagesize(IMAGE_CHANGE.$groupDetail->profilePic)){
								$img = IMAGE_CHANGE.$groupDetail->profilePic;
                                ...
                                <div class="education-desc">
                                    ...
                                    <div class="edu-desc-row" id="group-title" >
                                        ...
                                        <h3>title</h3>
                                        <h4><?php echo $groupDetail->name  ?></h4>
                                    </div>
                                    <div class="edu-desc-row" id="replace-group-title"   >

                                        <h3>title</h3>
                                        <textarea class="group-title" ><?php echo $groupDetail->name  ?></textarea>
                                    ...
                                    <div id="group-about" class="edu-desc-row">
                                        ...
                                        <h3>description</h3>
                                        <p><?php echo nl2br($groupDetail->description)  ?></p>
                                    </div>
                                    <div id="replace-group-about" class="edu-desc-row">

                                        <h3>description</h3>
                                        <textarea name="description" class="group-title" ><?php echo $groupDetail->description   ?></textarea>
                                        <h3></h3>
                            ...
                            'url' => array('controller' => 'groups', 'action' => $this->request->param('groupName') , 'more' )));
