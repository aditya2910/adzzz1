<?php   echo $this->element('group/'.'media_media_menu',array('select' => 'videos')); ?>
    <div class="clear"></div>
        ...
        <div id="filter-videos" class="filter-con-row"  >
            ...
            <div class="profile-row-mids">
                <div class="filter-con-row-inner" id='user_media_videos' >
                        <?php foreach($videoArray as $index => $vid ) { if(file_exists(POST_IMAGE_UPLOAD_FOLDER.$vid->link)) { ?>
                                <div class="filter-box user_media_video">
                                    <div class="filter-box-thumb">
										<?php echo $this->Html->image(VIDEO_THUMB.$vid->link."/mqdefault.jpg"); ?>
