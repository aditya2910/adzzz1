...
$(document).ready(function () {
        ...
        $('#replace-group-title').on('click','input:button',function(){
           ...
           var data = {name : text, id : jsVars .wall_id,user_id : jsVars.user_id};
           new callAjax(data,'groups/'+jsVars .wall_id+'/updateGroupName','feedback').fire();
        ...
        $('#replace-group-about').on('click','input:button',function(){
            ...
            var data = {description : about, id : jsVars .wall_id};
            console.log(data);
            new callAjax(data,'groups/'+jsVars .wall_id+'/updateGroupDescription','feedback').fire();
